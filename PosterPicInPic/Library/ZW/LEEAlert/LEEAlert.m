...
//zw添加的view
//@property (nonatomic , strong ) UIView *yuan;
@end
...
//            self.yuan.frame = CGRectMake(self.containerView.frame.size.width/2-self.yuan.frame.size.width/2, -self.yuan.frame.size.width/2, 80, 80);
//            self.yuan.backgroundColor = [UIColor redColor];
...
//    self.yuan = [UIView new];
//    [self.containerView addSubview:self.yuan];
